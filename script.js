  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      const existingError = field.parentElement
        ? field.parentElement.querySelector('.error-message[data-for="' + (field.id || field.name) + '"]')
        : null;
    ...
    function validateField(field) {
      ...
      if (isRequired && !VALIDATORS.required(field.type === 'checkbox' ? (field.checked ? 'checked' : '') : value)) {
      ...
      if ((fieldType === 'email' || field.getAttribute('type') === 'email') && !VALIDATORS.email(value)) {
        showFieldError(field, getErrorMessage(field, 'email'));
        return false;
      }

      if ((fieldType === 'tel' || field.getAttribute('type') === 'tel') && !VALIDATORS.tel(value)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c40e5a3a-1cf9-4579-a119-63f804c32508',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c40e5a3a-1cf9-4579-a119-63f804c32508';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c40e5a3a-1cf9-4579-a119-63f804c32508';
